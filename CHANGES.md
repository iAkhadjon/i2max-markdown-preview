...
- Local Markdown preview (markdown-it renderer) — single command: **Open Preview to the Side**
- Scroll sync, live update
...
## Additional Changes (fourth pass — command cleanup)

| Item                       | Change                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `package.json` commands    | Removed 17 commands. Only `i2max-markdown-preview.openPreviewToTheSide` remains. Removed: `openPreview`, `toggleScrollSync`, `toggleLiveUpdate`, `toggleBreakOnSingleNewLine`, `syncPreview`, `customizeCss`, `customizeCssInWorkspace`, `insertNewSlide`, `insertTable`, `insertPagebreak`, `createTOC`, `openConfigScript`, `extendParser`, `customizePreviewHtmlHead`, `openConfigScriptInWorkspace`, `extendParserInWorkspace`, `customizePreviewHtmlHeadInWorkspace` |
| `package.json` keybindings | Removed 4 dead keybindings (`openPreview`, `runAllCodeChunks`, `runCodeChunk`, `syncPreview`). Only `openPreviewToTheSide` (<kbd>Cmd+K V</kbd>) remains.                                                                                                                                                                                                                                                                                                                  |
| `package.nls.json`         | Removed 17 unused translation entries. Kept: `displayName`, `description`, `customEditorPreviewDisplayName`, `openPreviewToTheSide.title`.                                                                                                                                                                                                                                                                                                                                |
| `src/extension-common.ts`  | Removed 14 functions: `openPreview`, `toggleScrollSync`, `toggleLiveUpdate`, `toggleBreakOnSingleNewLine`, `syncPreview`, `insertNewSlide`, `insertTable`, `insertPagebreak`, `createTOC`, `customizeCSSInWorkspace`, `openConfigScriptInWorkspace`, `extendParserInWorkspace`, `customizePreviewHtmlHeadInWorkspace`, `openConfigFileInWorkspace`. Removed helper `getCurrentWorkingDirectory`. Removed all corresponding `registerCommand` calls.                       |
| `src/extension.ts`         | Removed 4 global config functions (`customizeCSS`, `openConfigScript`, `extendParser`, `customizePreviewHtmlHead`) and their registrations. Removed unused imports (`utility` from crossnote, `path`).                                                                                                                                                                                                                                                                    |
