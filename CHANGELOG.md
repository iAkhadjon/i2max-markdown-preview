...
For releases, please visit the [project releases page](https://github.com/shd101wyy/vscode-i2max-markdown-preview/releases).
...
- Fix preview selection in loop iteration [PR#2182](https://github.com/shd101wyy/vscode-i2max-markdown-preview/pull/2182).
...
- Add `i2max-markdown-preview.liveUpdateDebounceMs` setting to control the live update debounce time in milliseconds. Default is `300ms`.
- Allow to disable auto-preview config for specific URI schemes. Fixed the issue [#604](https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/604) by @alonsorobots.
...
- Fixed [a bug of link redirection in preview](https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1951) by @byte-clown
...
- Fixed [[BUG] #tag is treated as Header 1](https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1937)
- Fixed [[BUG] toml code block support is not very good](https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1920)
- Fixed [[BUG] If URL encoding is used, the preview cannot be displayed.](https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1934)
...
- Fixed rendering `vega-lite` in `Reveal.js` slide: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1880
...
- Fixed importing file with spaces in the path: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1857
- Fixed a bug of updating the vscode `workbench.editorAssociations`: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1860
...
- Fixed of bug of rendering the KaTeX math expression: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1853
...
- (Beta) Supported to export the selected element in preview to .png file and copy the blob to the clipboard:
  ...
  ![image](https://github.com/shd101wyy/vscode-i2max-markdown-preview/assets/1908863/046759d8-6d89-4f41-8420-b863d2094fe7)

### Bug fixes

- Fixed a bug of importing files that contains empty heading: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1840
- Fixed a bug of rendering inline math in image name: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1846
- Fixed a bug of parsing inline code: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1848
...
- URL fragments on image links do not load: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1837
...
- Fixed a header id generation bug https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1833
- Fixed parsing block attributes from curly bracket when `enableTypographer` is enabled https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1823
- Fixed the bug of not rendering the `@import` file:
  - https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1832
  - https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1834
...
- Improved the handling of `[toc]`: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1825
- Supported to set env variables in paths of configuration: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1826
- Fixed the footer style: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1822
- Fixed the bug of generating the header id: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1827
- Fixed the bug of `@import` files that contains unicode characters: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1823
...
- Fixed a bug of loading image https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1819
- Fixed a bug of parsing slides https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1818

## [0.8.2] - 2023-10-09

Special Thanks to [@mavaddat](https://github.com/mavaddat) for creating the awesome extension logo for MPE in this [pull request](https://github.com/shd101wyy/vscode-i2max-markdown-preview/pull/1808) 🎉 We finally have a beautiful logo for MPE.
...
- Supported prefix in front of Kroki diagram types https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1785.  
...
- Fixed some Reveal.js presentation related bugs:
  - https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1815
  - https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1814
...
- Deprecated the VS Code setting `i2max-markdown-preview.singlePreview`.  
  Now replaced by `i2max-markdown-preview.previewMode`:
...
- Fixed the anchor jump bugs: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1790
- Fixed list item style bug: https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1789
...
- Fixed the `none.css` preview theme bug https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1778.
- Fixed the bug of copying texts in preview https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1775.
...
- Fixed the back to top button. https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1769
...
- (Beta) Added the [bitfield](https://github.com/wavedrom/bitfield) diagram support. Supported both `bitfield` and `bit-field` code fences. https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1749
  ````
  ```bitfield {vspace=100}
  [
    {name: 'IPO',   bits: 8},
...
2. Backlinks supported in the preview. Clicking the bottom right link icon will display the backlinks. This feature is currently in beta and might not be stable yet.  
   ...
   ```
   "i2max-markdown-preview.alwaysShowBacklinksInPreview": true,
   ```
...
1. 🐞 [Issue 1752](https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1752)
...
- ⭐ Added `i2max-markdown-preview.markdownFileExtensions` config that allows users to specify the file extensions for preview.
...
- :bug: [Single preview bug](https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1740)
...
- MPE is now available on [VSCode for the Web](https://vscode.dev) 🥇 Yes, you can now use MPE in your browser. But some features are limited, like exporting files and code chunks, which are disabled in the browser environment. I am writing this CHANGELOG right now in [vscode.dev](https://vscode.dev) using the MPE extension 😃.
  ...
  ![image](https://github.com/shd101wyy/vscode-i2max-markdown-preview/assets/1908863/9222fc77-6bf2-4fd6-bc94-bd8c1953bc24)
...
- Fixed [Issue 1736](https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1736)
- Fixed [Issue 1737](https://github.com/shd101wyy/vscode-i2max-markdown-preview/issues/1737) 🚗
...
- ➕ Supported to configure: `i2max-markdown-preview.mathjaxV3ScriptSrc`, `i2max-markdown-preview.plantumlJarPath`, and `i2max-markdown-preview.krokiServer`.
- 🔰 Updated [@shd101wyy/mume](https://github.com/shd101wyy/mume) to version [0.7.8](https://github.com/shd101wyy/mume/pull/297).
  ...
  - :newspaper: Removed the `plantuml.jar` file from the `mume` project. Now you need to download the plantuml.jar file manually from [here](https://plantuml.com/download).
    ...
    - If you are using VSCode, you can set the `i2max-markdown-preview.plantumlJarPath` option in the VSCode settings.
